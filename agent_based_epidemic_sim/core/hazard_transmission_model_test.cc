...
TEST(HazardTransmissionModelTest, GetsInfectionOutcomes) {
  std::unique_ptr<HazardTransmissionModel> transmission_model =
      HazardTransmissionModel::CreateWithDistanceFunction(
          /* lambda */ 1.0f,
          [](float proximity) { return (proximity <= 1) ? 10 : 0; });
...
TEST(HazardTransmissionModelTest,
  ...
  std::unique_ptr<HazardTransmissionModel> transmission_model =
      HazardTransmissionModel::CreateWithDefaultDistanceFunction(
          /* lambda */ 1.0f);
